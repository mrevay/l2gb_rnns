    ...
    def solve(self):
        ...
        def validate(loader, sim=True):
            ...
            with torch.no_grad():
                for u, y in loader:
                    if sim:
                        yest = self.model.simulate(u[0], u[1])
                    else:
                        yest = self.model.forward(u[0], u[1])
        ...
        with torch.no_grad():
            ...
            tloss = validate(self.train_loader, sim=False)
