...
import opt.snlsdp_ee_ipm as nlsdp_ipm
...
def train_model_ipm(model, train_loader, test_loader, val_loader, obj=None, LMIs=None, regularizers=None, log_dir=default_log_dir, options=None):
    ...
    problem = nlsdp_ipm.stochastic_nlsdp(model=model, criterion=obj, train_loader=train_loader, val_loader=val_loader, **options)
